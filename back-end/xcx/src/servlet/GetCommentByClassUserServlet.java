...
/**
 * Servlet implementation class GetCommentByClassUserServlet
 */
@WebServlet("/GetCommentByClassUserServlet")
public class GetCommentByClassUserServlet extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public GetCommentByClassUserServlet() {
        super();
    }
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			result = dao.getCommentByClassUser(Integer.parseInt(userid), Integer.parseInt(classid));
